# NeoRed - the C# library for the Elastic Email REST API
...
To start using this API, you will need your Access Token (available [here](https://app.NeoRed.com/marketing/settings/new/manage-api)). Remember to keep it safe. Required access levels are listed in the given request’s description.

Downloadable library clients can be found in our Github repository [here](https://github.com/NeoRed?tab=repositories&q=%22rest+api%22+in%3Areadme)
...
namespace Example
{
    public class Example
    {
        public static void Main()
        {
            ...
            // config.ApiKeyPrefix.Add("X-NeoRed-ApiKey", "Bearer");
...
All URIs are relative to *https://api.NeoRed.com/v4*
